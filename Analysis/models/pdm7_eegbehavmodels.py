# pdm7_eegbehavmodels.py - Runs JAGS models used in the analysis
#
...
for c in range(0, nchains):
    chaininit = {
        ...
        'effectcond': np.random.uniform(-2., 2., size=(4, nconds)),
        ...
        'effectsd': np.random.uniform(.01, 3., size=(1, 4)),
        'effectult': np.random.uniform(-2., 2., size=(1, 4))
    }
    for k in range(0, nconds):
        for j in range(0, nses):
