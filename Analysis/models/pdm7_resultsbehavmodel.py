# pdm7_resultsbehavmodel.py - Plots results of behavior_only JAGS models
#
...
modelfile = loadloc + '/' + 'model_behavior_onlyOct_30_18_13_04.mat'
...
plt.title('Condition-level probability of mind-wandering', fontsize=fontsize)

# plt.figure()
# jellyfish(samples['probsub'])
# plt.title('Session-level probability of mind-wandering', fontsize=fontsize)

# plt.figure()
# jellyfish(samples['tersub'])
# plt.title('Session-level non-decision time', fontsize=fontsize)